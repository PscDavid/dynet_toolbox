...
%--------------------------------------------------------------------------
% INPUTs
% - ConnMatrix:       [Nodes X Nodes X Freq X Time] 
% - time:             Time vector [1 X Time]
% - freq:             Frequencies vector [1 X Freq]
% - labels:           Nodes labels (1:numel(nodes), default) 
% - quantrange:       ([.01 .99], default)
% - cmap:             Colormap colors (jet, default)
% - SC:               No structural matrix info (0, default) otherwise
%                     structural matrix [Nodes X Nodes]
% - univ:             Remove (0, default) diagonal plots otherwise keep (1)
%--------------------------------------------------------------------------
% INVOKED FUNCTIONs
% expandsubplot.m; subtightplot.m; vline.m
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
