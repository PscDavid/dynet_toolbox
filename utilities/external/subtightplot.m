...
%==========================================================================
% Wrapper function for Matlab function subplot. Adds the ability to 
% define the gap between neighbouring subplots. Unfotrtunately Matlab 
% subplot function lacks this functionality, and the gap between
% subplots can reach 40% of figure area, which is pretty lavish.
%--------------------------------------------------------------------------
% INPUTs (defaults exist):
% - gap     two elements vector [vertical,horizontal] defining the gap 
%           between neighbouring axes. Default value is 0.01. Note this 
%           value will cause titles legends and labels to collide with the 
%           subplots, while presenting relatively large axis.
% - marg_h  margins in height in normalized units (0...1)
%            or [lower uppper] for different lower and upper margins
% - marg_w  margins in width in normalized units (0...1)
%            or [left right] for different left and right margins
%--------------------------------------------------------------------------
% OUTPUTs same as subplot- none, or axes handle according to function call.
%--------------------------------------------------------------------------
% Issues & Comments: Note that if additional elements are used in order to 
% be passed to subplot, gap parameter must be defined. For default gap 
% value use empty element- [].
%--------------------------------------------------------------------------
...
% Above line doesn't work as subplot tends to ignore 'position' when 
% same mnp is utilized
