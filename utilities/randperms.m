...
%     randperms(6,1:3) returns 1st-3rd elements of randperm(6) might be [2 4 5].
%     randperms(2,6) returns might be [2 4 5 6 3].
%     randperms(2,6,2) returns 2nd element of randperms(2,6) might be 4.
%     randperms(2,6,2:4) returns 2nd-4th elements of randperms(2,6) might be [4 5 6 3].
%
